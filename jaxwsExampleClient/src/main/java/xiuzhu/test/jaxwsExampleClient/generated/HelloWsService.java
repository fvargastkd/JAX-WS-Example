 ...
 * 
 */
@WebServiceClient(name = "HelloWsService", targetNamespace = "http://ws.jaxwsExample/", wsdlLocation = "http://localhost:8080/jaxwsExample/HelloWs?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jaxwsExample/HelloWs?wsdl");
